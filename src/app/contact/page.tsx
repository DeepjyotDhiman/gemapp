        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-[#E8E2D6] p-6 sm:p-7 subtle-shadow space-y-4">
              ...
              <a
                href="https://wa.me/919106765594?text=Hello%20Bhatia%20Gems,%20I%20have%20an%20inquiry%20regarding%20natural%20gemstones."
                target="_blank"
              ...
              <ul className="space-y-4 text-xs text-[#57534E]">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span>+91 91067 65594 [Placeholder]</span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span>dhiman.deepjyot2006@gmail.com [Placeholder]</span>
                  </div>
                </li>
              </ul>
